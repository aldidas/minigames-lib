...
/**
 * Ref handle exposed by BreakoutGame component for manual control
 */
export interface BreakoutGameHandle {
  start: () => void;
  stop: () => void;
  pause: () => void;
  resume: () => void;
 ...
 * @example
 * ```tsx
 * const gameRef = useRef<BreakoutGameHandle>(null);
 * 
 * <BreakoutGame
 *   ref={gameRef}
 ...
 * ```
 */
export const BreakoutGame = forwardRef<BreakoutGameHandle, BreakoutGameProps>(
